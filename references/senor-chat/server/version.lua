local updateUrl = 'https://raw.githubusercontent.com/darealsenor/senor-chat-fivem/refs/heads/main/version'
...
local function processVersionCheck()
    ...
    if needsUpdate(localVerNum, remoteVerNum) then
        ...
        lib.print.info('^2You are running the latest version of senor-chat. Thanks for buying! :)')
    end
