local updateUrl = 'https://raw.githubusercontent.com/darealsenor/senor-squads-fivem/refs/heads/main/version'
...
local function processVersionCheck()
    ...
    if needsUpdate(localVerNum, remoteVerNum) then
        ...
        lib.print.info('^2You are running the latest version of senor-squads. Thanks for buying! :)')
    end
...
local function startVersionCheck()
    if not ServerConfig.VersionCheck then
        return
    end
